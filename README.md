...
- Record settlements to mark debts as paid
...
Helpers in `lib/money.ts`: `toPaise()`, `toINR()`, `formatCurrency()`, `calcEqualSplits()`, `calcPercentageSplits()`, `validateExactSplits()`.
